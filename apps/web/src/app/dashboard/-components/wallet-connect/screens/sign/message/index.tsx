...
import { parseSession, parseSignMessageRequest } from "@/lib/utils";
...
export const SignMessageScreen = () => {
  ...
  const request = useMemo(() => {
    ...
    return parseSignMessageRequest(currentRequest);
  }, [currentRequest]);
  ...
  return (
    <div>
      <div className="flex flex-row items-start gap-2 border-neutral-300 border-b p-4 text-primary">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="font-medium text-neutral-400 text-sm">
            Sign a message using your Karma Smart Account
          </div>
        </div>
      </div>
      ...
      <div className="space-y-2 border-neutral-300 border-b p-3">
        <div className="px-2 font-medium text-neutral-600 text-sm">Message</div>
        <div className="w-full space-y-2 rounded-2xl bg-neutral-100 px-6 py-3 text-neutral-600">
          {hexToString(request?.params.message ?? "0x0")}
        </div>
      </div>
